...
namespace Stratman.Windows.Forms.TitleBarTabs
{
	...
	public class ListWithEvents<T> : List<T>, IList
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ListWithEvents{T}" /> class that is empty and has the default initial capacity.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ListWithEvents{T}" /> class that is empty and has the specified initial capacity.
		/// </summary>
		...
		/// <remarks>
		/// This operation employs <see cref="Remove" /> method for removing each individual item which is thread-safe.  However overall operation isn't 
		/// atomic, and hence does not guarantee thread-safety.
		/// </remarks>
