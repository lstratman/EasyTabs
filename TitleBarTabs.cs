...
namespace Stratman.Windows.Forms.TitleBarTabs
{
    ...
    public abstract partial class TitleBarTabs : Form
    {
        ...
        /// <summary>
        /// Event delegate for <see cref="TitleBarTabs.TabSelected" /> and <see cref="TitleBarTabs.TabDeselected" />.
        /// </summary>
        /// <param name="sender">Object for which this event was raised.</param>
        /// <param name="e">Data associated with the event.</param>
        ...
        /// <summary>
        /// Callback for the <see cref="TabDeselecting" /> event.  Called when a <see cref="TitleBarTab" /> is in the process of losing focus.  Grabs an image
        /// of the tab's content to be used when Aero Peek is activated.
        /// </summary>
        /// <param name="e">Arguments associated with the event.</param>
        ...
        /// <summary>
        /// Callback for the <see cref="TabSelected" /> event.  Called when a <see cref="TitleBarTab" /> gains focus.  Sets the active window in Aero Peek via
        /// a call to <see cref="TabbedThumbnailManager.SetActiveTab(Control)" />.
        /// </summary>
        /// <param name="e">Arguments associated with the event.</param>
        ...
        /// <summary>
        /// Handler method that's called when Aero Peek needs to display a thumbnail for a <see cref="TitleBarTab" />; finds the preview bitmap generated
        /// in <see cref="TabDeselecting" /> and returns that.
        /// </summary>
        ...
        /// <summary>
        /// Resizes the <see cref="TitleBarTab.Content" /> form of the <paramref name="tab" /> to match the size of the client area for this window.
        /// </summary>
        /// <param name="tab">
        /// Tab whose <see cref="TitleBarTab.Content" /> form we should resize; if not specified, we default to
        ...
        /// </summary>
        /// <param name="sender">
        /// Object from which this event originated (the <see cref="TitleBarTab.Content" /> object in this case).
        /// </param>
        /// <param name="e">Arguments associated with the event.</param>
        ...
        /// </summary>
        /// <param name="sender">
        /// Object from which this event originated (the <see cref="TitleBarTab" /> in this case).
        /// </param>
        /// <param name="e">Arguments associated with the event.</param>
        ...
        /// <summary>
        /// Overrides the <see cref="Control.SizeChanged" /> handler so that we can detect when the user has maximized or restored the window and adjust the
        /// size of the non-client area accordingly.
        /// </summary>
        /// <param name="e">Arguments associated with the event.</param>
        ...
        /// </summary>
        /// <param name="m">
        /// Message received by <see cref="WndProc" />.
        /// </param>
        /// <returns>
